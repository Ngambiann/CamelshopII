<template>
            ...
            <v-card-text>
                <v-form v-model="valid">
                    <v-container>
                        <v-row>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="newProduct.productName" label="Item Name"
                                    required></v-text-field>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="newProduct.productPrice" label="Product Price" hide-details
                                    required></v-text-field>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="newProduct.productDescription" label="Description" hide-details
                                    required></v-text-field>
                            </v-col>
                        </v-row>
                        <v-row>
                            <v-col cols="12" md="4">
                                <v-select v-model="newProduct.productCategory" :items="productCategoryItems"
                                    item-title="categoryName" item-value="categoryID" label="Category"></v-select>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-select v-model="newProduct.productMeasurement" :items="productMeasurementList"
                                    label="Measurement"></v-select>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="newProduct.productImagePath" label="Image" hide-details
                                    required></v-text-field>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="newProduct.productNumber" label="Stock Number" hide-details
                                    required></v-text-field>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="newProduct.productQuantity" label="Quantity" hide-details
                                    required></v-text-field>
                            </v-col>
                        </v-row>
                    </v-container>
    ...
    <v-dialog v-model="show_dialog" width="auto">
        <v-card class="mx-auto my-12" max-width="374">
            ...
            <v-img height="250" :src="editProductItems.productImagePath" cover></v-img>
    ...
    // Edit Product 
    <v-dialog v-model="edit_dialog" width="auto">
            ...
            <v-card-text>
                <v-form v-model="valid_edit">
                    <v-container>
                        <v-row>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="editProductItems.productName" label="name"
                                    required></v-text-field>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="editProductItems.productPrice" label="Product Price" hide-details
                                    required></v-text-field>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="editProductItems.productDescription" label="Description"
                                    hide-details required></v-text-field>
                            </v-col>
                        </v-row>
                        <v-row>
                            <v-col cols="12" md="4">
                                <v-select v-model="editProductItems.productCategory" :items="productCategoryItems"
                                    item-title="categoryName" item-value="categoryID" label="Category"></v-select>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-select v-model="editProductItems.productMeasurement" :items="productMeasurementList"
                                    label="Measurement"></v-select>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="editProductItems.productImagePath" label="Image" hide-details
                                    required></v-text-field>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="editProductItems.productNumber" label="Stock Number" hide-details
                                    required></v-text-field>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="editProductItems.productQuantity" label="Quantity" hide-details
                                    required></v-text-field>
                            </v-col>
                        </v-row>
                    </v-container>
